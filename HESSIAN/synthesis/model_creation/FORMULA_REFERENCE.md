...
### Issue 1: Multiple $c_0$ Definitions
- **Ch 25.3:** SU(2) Haar eigenvalue at origin = $1/6$
- **Ch 24.4:** SU(N) formula $c_0 = (N^2-1)/2N$ giving SU(2) = $3/4$

**These are different constants.** Need to distinguish notation.

### Issue 2: Verify Fixed Point
Fixed point of $\dot\lambda = \sigma - 2\lambda^2$ is $\lambda_* = \sqrt{\sigma/2}$.
Check all downstream references use correct coefficient.
