...
The ledgers are the corpus's own registers (MASTER_THEORY §8 and §9) rendered
machine-readable. Validation here is structural: ids well-formed and complete,
cross-references resolving, vocabularies closed. It says nothing about physics.
"""
