...
def _():
    ...
    return not unaccounted, (
        ...
        "headline -- DELTA_BETA_3 among them, so the balanced side of C2 is registered and "
        f"checked by nothing. {len(connected)} previously-stranded nodes have since gained an edge"
