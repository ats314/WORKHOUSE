...
5 September 2026. This sharpens the conservative global-barrier derivation,
preserved with the original research evidence in the
[nonlinear block run](../../runs/nonlinear_wilson_block_2026-09-05/README.md). The preceding sealed scale-comparison
package remains unchanged. The statements below concern the actual intrinsic
...
[physical fiber proof](G19_WILSON_PHYSICAL_FIBER_FAST_GAP_20260905.md), Sections
...
[actual strip decomposition](G19_WILSON_STRIP_BO_AND_TWO_STRIP_SPLITTING_20260905.md),
...
theorems cited above. The conservative predecessor and the independent
[audit and exact controls](../../runs/nonlinear_wilson_block_2026-09-05/README.md) retain their original provenance.
The previous sealed proof and run packages remain unchanged.

The [run instructions](../../runs/nonlinear_wilson_block_2026-09-05/README.md) provide the guarded native verifier
and read-only replay. The original
[control source](../../runs/nonlinear_wilson_block_2026-09-05/check_global_wilson_vertical_barrier.py) and
[saved certificate](../../runs/nonlinear_wilson_block_2026-09-05/check_global_wilson_vertical_barrier.json) are preserved.
...
The supplementary [Lean scalar kernel](../../lean/Workhouse/GlobalWilsonVertical.lean)
formalizes seven real inequalities for the factor, cap, affine comparison,
two-sector assembly and threshold under their explicit analytic inputs.
It does not formalize SU(N), operator domains, min-max, ground positivity,
full-vacuum subtraction or a volume limit. The native finite checks and
these formal scalar statements support their declared parts of the analytic proof.
