...
5 September 2026. Outputs-only analytic candidate for one adjacent two-square
...
The new input
[NEAR_IDENTITY_WILSON_GROUND_BUNDLE.md](NEAR_IDENTITY_WILSON_GROUND_BUNDLE.md)
...
`G19_WILSON_PHYSICAL_FIBER_FAST_GAP_20260905.md`, with its localization proof,
...
`G19_FORM_SCHUR_SCALE_COMPARISON_20260905.md` applies to this actual block
...
[check_actual_complement_mechanism.py](check_actual_complement_mechanism.py),
with [saved exact output](check_actual_complement_mechanism.json), checks a
