...
5 September 2026. Outputs-only analytic derivation for the two-square bouquet
...
asserted. No canonical proof or sealed-run source is modified.

Established inputs are the exact metric and compact-neighborhood full fiber gap
in `paper/research_notes/G19_WILSON_PHYSICAL_FIBER_FAST_GAP_20260905.md`, sections
3–4, and the exact horizontal decomposition in
`G19_WILSON_STRIP_BO_AND_TWO_STRIP_SPLITTING_20260905.md`, sections 1, 3–4.
The new global complement/barrier theorem is a complementary input in
[GLOBAL_WILSON_VERTICAL_BARRIER.md](GLOBAL_WILSON_VERTICAL_BARRIER.md); the
...
[symbolic control](check_ground_bundle_geometry.py), with
[saved output](check_ground_bundle_geometry.json), checks the rational metric/lift
