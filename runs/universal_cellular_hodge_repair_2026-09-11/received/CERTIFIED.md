...
**universal cellular Hodge and tetrahedral resolution**

- `R S^m R Carrier Symbol Master Theorem: exact closed rational polynomial for m=0..4`
  - src/workhouse/invariants/universal_cellular_hodge.py:239 · UNIVERSAL_CELLULAR_HODGE_TETRAHEDRAL Theorem 7; G9; G14; U2
  - `workhouse verify --only 'R S^m R Carrier Symbol Master Theorem: exact closed rational polynomial for m=0..4'`
- `tetrahedral Hodge duality and S_4 commutant theorem`
  - src/workhouse/invariants/universal_cellular_hodge.py:130 · UNIVERSAL_CELLULAR_HODGE_TETRAHEDRAL Theorem 4 and 5; U3; ADR 0008; ADR 0045
...
- `tetrahedral proper returns: all 60 fourth-order histories vanish under intermediate Q-projection`
  - src/workhouse/invariants/universal_cellular_hodge.py:173 · UNIVERSAL_CELLULAR_HODGE_TETRAHEDRAL Theorem 6; U3; ADR 0008; ADR 0045
  - `workhouse verify --only 'tetrahedral proper returns: all 60 fourth-order histories vanish under intermediate Q-projection'`
- `total Laplacian diagonal formula (L_tot)_{ff} = p_f + 1 settles link regularity`
  - src/workhouse/invariants/universal_cellular_hodge.py:90 · UNIVERSAL_CELLULAR_HODGE_TETRAHEDRAL Theorem 3; U7; ADR 0008
  - `workhouse verify --only 'total Laplacian diagonal formula (L_tot)_{ff} = p_f + 1 settles link regularity'`
- `universal cellular Hodge spectrum: lambda = |F| and excursions are up-harmonic`
  - src/workhouse/invariants/universal_cellular_hodge.py:28 · UNIVERSAL_CELLULAR_HODGE_TETRAHEDRAL Theorem 1 and 2; U7; G14
