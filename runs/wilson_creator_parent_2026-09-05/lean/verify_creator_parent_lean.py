...
Run from the repository root with:
    .venv\Scripts\python.exe -B outputs\creator_parent_20260905\verify_creator_parent_lean.py
...
def main() -> int:
    ...
    modules = [
        ...
        "Workhouse/VacuumCompression", "Workhouse/RootedScalarBounds", "Workhouse/CreatorParent", "Workhouse",
    ]
    results = []
    log = []
    ...
    report = {
        ...
        "axiom_guards": {"Workhouse.CreatorParent.idempotent_square_defect": ["propext", "Classical.choice", "Quot.sound"], "Workhouse.CreatorParent.commuting_pair_square": ["propext"], "Workhouse.CreatorParent.wilson_gap_constant": ["propext", "Classical.choice", "Quot.sound"],
            "Workhouse.RootedScalarBounds.normalized_taylor_growth": [
