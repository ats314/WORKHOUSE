...
5 September 2026. Outputs-only continuation. This derives the exact endpoint
...
`paper/research_notes/G19_BALABAN_BLOCKING_REFLECTION_POSITIVITY_20260830.md`.
...
The verifier is [check_gaussian_endpoint_baseline.py](check_gaussian_endpoint_baseline.py);
its exact result is [gaussian_endpoint_baseline_controls_frozen.json](gaussian_endpoint_baseline_controls_frozen.json).
From this directory, replay it with
