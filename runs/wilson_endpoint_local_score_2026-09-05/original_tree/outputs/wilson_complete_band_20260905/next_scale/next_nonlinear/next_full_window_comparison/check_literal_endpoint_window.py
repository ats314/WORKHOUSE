"""Exact finite endpoint-window, two-lag and failure controls.

No numerical eigensolver is used. The all-size Wilson and spectral-domain
statements belong to the analytic proof, not these finite examples.
"""
...
def main():
    ...
    proof = here.with_name("LITERAL_ENDPOINT_COMPLETE_WINDOW.md")
    repo = here.parents[5]
    notes = repo / "paper/research_notes"
    paths = (
        here,
        proof,
        notes / "G18_EXCITED_WINDOW_OPERATOR_BRIDGE_20260904.md",
        notes / "G19_WILSON_LITERAL_VACUUM_COARSE_SOURCES_20260905.md",
        notes / "G19_WILSON_COMMON_GAUSS_LITERAL_FAST_FLOOR_20260905.md",
        notes / "G19_TRUE_GROUND_CENTER_SCORE_OBSTRUCTION_20260905.md",
    )
    ...
    with args.output.open("x", encoding="utf-8", newline="\n") as stream:
        ...
        stream.write("\n")
    print("PASS: four exact endpoint-window/control families")
