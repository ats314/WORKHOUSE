...
5 September 2026. Analytic exact-score successor. This note disproves the
specific global true-ground Fisher growth candidate proposed in Section 5
of [the generic score theorem](G19_GROUND_MARGINAL_SCHUR_SCORE_20260905.md). Its generic intrinsic-score
...
proof notes. The canonical adjacent-strip and conditional fiber theorems are
not premises identifying this bouquet's conditional density.

The companion [check_central_score_identity_independent.py](../../runs/literal_quantum_sources_2026-09-05/check_central_score_identity_independent.py) tests the
