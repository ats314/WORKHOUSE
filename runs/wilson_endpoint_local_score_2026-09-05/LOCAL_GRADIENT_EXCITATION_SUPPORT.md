...
5 September 2026. Outputs-only continuation. The mathematical object here is
...
`G19_WILSON_COMMON_GAUSS_LITERAL_FAST_FLOOR_20260905.md`, and the selected-window
score obligations in `G19_TRUE_GROUND_CENTER_SCORE_OBSTRUCTION_20260905.md`,
Section 5. No frozen source or run is changed.
