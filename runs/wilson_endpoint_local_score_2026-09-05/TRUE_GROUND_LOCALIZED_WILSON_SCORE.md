...
5 September 2026. Outputs-only analytic continuation. The result is an
...
localization are in `G19_WILSON_TWO_SQUARE_PHYSICAL_SHELLS_20260905.md`,
Sections 2-4. The exact score identity is in
`G19_GROUND_MARGINAL_SCHUR_SCORE_20260905.md`, Sections 1-3. The literal/common
