...
def main():
    ...
    paths = (
        ...
        here / "ENTIRE_GAUSSIAN_LITERAL_COMPLEMENT.md",
        repo / "paper/research_notes/G19_WILSON_THREE_DIMENSIONAL_HARMONIC_BOUNDARY_20260905.md",
        repo / "paper/research_notes/G19_WILSON_HARMONIC_BOUNDARY_COMPARISON_20260905.md",
        repo / "paper/research_notes/G19_FORM_SCHUR_SCALE_COMPARISON_20260905.md",
    )
    ...
    before = hashes()
    result = controls()
    require(before == hashes(), "source bytes unchanged during exact verification")
    report = {
        "schema": "workhouse-entire-gaussian-literal-controls/v1",
        "passed": True,
        "scope": __doc__,
        "controls": result,
        "sources": before,
    ...
    with args.output.open("x", encoding="utf-8", newline="\n") as stream:
        ...
        stream.write("\n")
    print(
        json.dumps({"output": str(args.output), "passed": True, "families": list(result)}, indent=2)
    )
