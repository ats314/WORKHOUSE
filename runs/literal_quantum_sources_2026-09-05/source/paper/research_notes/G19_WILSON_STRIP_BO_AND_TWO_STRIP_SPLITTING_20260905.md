...
5 September 2026. Analytic derivation for the finite two-square
...
[G19_WILSON_BLOCK_SCORE_AND_FIBER_OBSTRUCTION_20260905.md](G19_WILSON_BLOCK_SCORE_AND_FIBER_OBSTRUCTION_20260905.md),
Section 6.1. The required uniform vertical oscillator isolation is
proved in [G19_WILSON_PHYSICAL_FIBER_FAST_GAP_20260905.md](G19_WILSON_PHYSICAL_FIBER_FAST_GAP_20260905.md).
...
[STRIP_BORN_OPPENHEIMER_INDEPENDENT_AUDIT.md](../../runs/continuum_wilson_block_2026-09-05/STRIP_BORN_OPPENHEIMER_INDEPENDENT_AUDIT.md).
The [sealed run](../../runs/continuum_wilson_block_2026-09-05/README.md) preserves these reproducible controls:
