...
5 September 2026. Outputs-only mathematical derivation. This computes a
...
[RG_CONDITIONAL_GRADIENT_REPAIR.md](RG_CONDITIONAL_GRADIENT_REPAIR.md)
...
[REVERSE_MASS_MATCHING.md](REVERSE_MASS_MATCHING.md) correctly constructs
...
Run `check_wilson_block_score.py` in this directory with the repository
Python environment. It writes `wilson_block_score_controls.json`.
...
notes were independently audited in Section 7. No canonical proof,
source pin or truth status is changed by this outputs-only analysis.
