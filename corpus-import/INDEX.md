...
**Rebuilt August 20, 2026** against the actual filesystem after the reorganization (DECISIONS #012). The June 15 version is byte-preserved at `records/governance_archive/INDEX_2026-06-15_ORIGINAL.md`.
...
│     MASTER_THEORY_UNIFIED_2026-08-20_v3.md        scientific + status authority
│     GLUEBALL_DETAILED_FORMULA_DOCUMENT_..._v3_1.md coefficient-level technical appendix
│     GLUEBALL_SOURCE_CONSOLIDATION_GUIDE_..._v3.md  navigation / return guide
│     GLUEBALL_CANONICAL_SOURCE_MANIFEST_..._v3.csv  byte-level provenance record
│
...
| If you want… | Go to |
|---|---|
| **The current scientific statement of the whole program** | `corpus/MASTER_THEORY_UNIFIED_2026-08-20_v3.md` |
| A specific coefficient, stencil weight, or polynomial | `corpus/GLUEBALL_DETAILED_FORMULA_DOCUMENT_..._v3_1.md` (`P₁₇` is in its Appendix A) |
| Which archived file a number came from | `corpus/GLUEBALL_CANONICAL_SOURCE_MANIFEST_..._v3.csv` |
