...
**Reading of V1–V5.** The contraction *primitive* (V1: SU(3) Haar + projectors, cross-checked
...
exact on the band that matters. These were the parts most likely to hide a subtle error.
...
2. **No genuinely independent recomputation of the \(H_4\) kernel.** See §4.
