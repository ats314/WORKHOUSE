...
gate("C-even k=0 A1++ reproduces the paper's -9397/1020 exactly",
     even_k0_A1 == F(-9397, 1020))
...
print(f"  => C-even A1++ curvature: (481/612)*(4/3) = {F(481,612)*F(4,3)} y^2 |k|^2")
...
print("""
SUMMARY (exact, O(y^2)):
  m+(k)  = 8/3 - y + y^2 [ 223/1020 - (481/612) lambda(k) ],  lambda in [-4,12]
           A1++ bottom (k=0): 8/3 - y - (9397/1020) y^2          [paper, gate]
           E++ channel (k=0): 8/3 - y + (223/1020) y^2           [new]
           curvature at bottom: + (481/459) |k|^2 y^2            [new]
