...
V9_C3_H=float(os.environ.get("V9_C3_H","0.0005"))
...
print("\n"+"="*128)
print("v9 — EXACT THIRD-ORDER LINKED WINDING-STRING CLOSURE")
print("="*128)
...
# Production strings.
print("\n"+"-"*128)
print("v9 WINDING-STRING PRODUCTION — GLOBAL-Q + CHARACTER VACUUM + EXACT LINKED O(u^3)")
print("-"*128)
...
print("-"*128)
print(f"PASSED {passed9}/{len(new_gates)} v9 GATES; cumulative {sum(ok for _,ok,_ in gates)}/{len(gates)}")
if passed9!=len(new_gates):
    raise AssertionError("v9 hard gate failure; do not interpret post-v8 ratio")
