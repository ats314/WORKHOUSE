...
| Dir | Campaign | One line |
|---|---|---|
| `op1_defect_sparsity/` | **OP-1 closure — the main thread** | (D) deterministic kernel accounting solved exactly (M1/M2); (S) stochastic sparsity lemma = the open piece (M3a, Alex's) |
...
Each campaign README states its **definition of done** (the shippable end-state, per `AGENT_PROTOCOL.md`) at the top.
