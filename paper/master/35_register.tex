...
\medskip
\input{gen_verification_register}
...
\begin{itemize}
  ...
  \item \textbf{A global fixed-window firewall.} Disproved by a Bernoulli
    no-go and replaced by the rooted conditional calculus.
\end{itemize}
