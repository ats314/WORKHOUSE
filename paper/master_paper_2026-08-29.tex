...
\item For every $N\ge3$ the complete momentum dependence at order $u^2$ is
  ...
  processes exhaust the second-order off-diagonal intermediates. The channel
  list they run through is complete (Lemma~\ref{lem:channels}); the process
  enumeration is what is assumed.
