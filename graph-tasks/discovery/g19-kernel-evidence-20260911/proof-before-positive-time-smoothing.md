...
actual continuum history-kernel convergence and zero-time regularity;
...
Four exact controls and five adversarial tests exercise finite Gram
quotients, rational interpolation, finite-energy weight and omitted
