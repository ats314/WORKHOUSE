...
convergence with zero-time regularity, positive separated-time physical
...
Four registered exact controls test finite Gram quotients, interpolation,
weight and limiting counterexamples. Five adversarial tests include a
